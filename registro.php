    ...
    <form class="geral-form">
        ...
        <div class="form-row">
            ...
            <div class="form-group">
                ...
                <input type="tel" id="telefone" name="telefone" pattern="([0-9]{2}) [0-9]{5}-[0-9]{4}" placeholder="Digite seu telefone" />
            </div>
        </div>
        ...
        <div class="form-row">
            ...
            <div class="form-group">
                ...
                <input type="password" id="confirmar-senha" name="confirmar-senha" required placeholder="Conforme sua senha" />
            </div>
        </div>

        <button type="submit" class="normal-button">Registrar</button>
        <aside>
            💡 Já possui uma conta? <a href="<?= $BASE_URL ?>/login.php"><strong>Entre aqui</strong></a>
        </aside>
    </form>
